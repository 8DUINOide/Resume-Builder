...
const ResumeTemplates = {
  ...
  ats_classic(data) {
    ...
    <div style="width:794px;min-height:1123px;padding:50px 56px;font-family:'Inter',Arial,sans-serif;color:#1a1a1a;line-height:1.55;background:white;box-sizing:border-box;">
      ...
      <div style="margin-bottom:18px;">
        <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#374151;border-bottom:2px solid #E5E7EB;padding-bottom:4px;margin:0 0 8px;">Professional Summary</h2>
      ...
      <div style="margin-bottom:18px;">
        <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#374151;border-bottom:2px solid #E5E7EB;padding-bottom:4px;margin:0 0 10px;">Work Experience</h2>
      ...
      <div style="margin-bottom:18px;">
        <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#374151;border-bottom:2px solid #E5E7EB;padding-bottom:4px;margin:0 0 10px;">Education</h2>
      ...
      <div style="margin-bottom:18px;">
        <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#374151;border-bottom:2px solid #E5E7EB;padding-bottom:4px;margin:0 0 8px;">Skills</h2>
      ...
      <div style="margin-bottom:18px;">
        <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#374151;border-bottom:2px solid #E5E7EB;padding-bottom:4px;margin:0 0 10px;">Projects</h2>
  ...
  canva_modern_1(data) {
    const p = data.personalInfo || {};
    const photoHtml = p.photoUrl ? `<img src="${p.photoUrl}" style="width:90px;height:90px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,0.3);margin-bottom:16px;">` : '';
    ...
    <div style="width:794px;min-height:1123px;display:flex;font-family:'Inter',Arial,sans-serif;color:#1a1a1a;line-height:1.5;background:white;box-sizing:border-box;">
      <!-- Sidebar -->
      <div style="width:260px;background:#312E81;color:white;padding:40px 24px;flex-shrink:0;">
      ...
      <div style="flex:1;padding:40px 36px;">
        ...
        ${data.summary ? `
        <div style="margin-bottom:24px;">
          <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#312E81;margin:0 0 8px;border-bottom:2px solid #E5E7EB;padding-bottom:4px;">About Me</h2>
          <p style="font-size:12px;color:#4B5563;margin:0;line-height:1.6;">${this._nl2br(data.summary)}</p>
        </div>` : ''}
        ...
        ${data.experience && data.experience.length ? `
        <div style="margin-bottom:24px;">
          <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#312E81;margin:0 0 10px;border-bottom:2px solid #E5E7EB;padding-bottom:4px;">Experience</h2>
          ${data.experience.map(exp => `
        ...
        ${data.projects && data.projects.length ? `
        <div>
          <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#312E81;margin:0 0 10px;border-bottom:2px solid #E5E7EB;padding-bottom:4px;">Projects</h2>
          ${data.projects.map(proj => `
          <div style="margin-bottom:10px;">
  ...
  canva_creative_2(data) {
    ...
    const photoHtml = p.photoUrl ? `<img src="${p.photoUrl}" style="width:80px;height:80px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,0.4);">` : '';
    ...
    <div style="width:794px;min-height:1123px;font-family:'Inter',Arial,sans-serif;color:#1a1a1a;line-height:1.5;background:white;box-sizing:border-box;">
      <!-- Banner -->
      <div style="background:linear-gradient(135deg,#BE185D,#9333EA);color:white;padding:36px 50px;display:flex;align-items:center;gap:24px;">
        ${photoHtml}
        <div>
      ...
      <div style="padding:30px 50px;">
        ...
        <div style="margin-bottom:22px;">
          <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#9333EA;margin:0 0 8px;">Profile</h2>
          <p style="font-size:12px;color:#4B5563;margin:0;line-height:1.6;">${this._nl2br(data.summary)}</p>
        </div>` : ''}
        ...
        <div style="display:flex;gap:30px;">
          ...
          <div style="flex:1.2;">
            ...
            ${data.experience && data.experience.length ? `
            <div style="margin-bottom:22px;">
              <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#9333EA;margin:0 0 10px;">Experience</h2>
              ${data.experience.map(exp => `
              <div style="margin-bottom:14px;padding-left:12px;border-left:3px solid #E9D5FF;">
                <strong style="font-size:13px;">${this._escapeHtml(exp.title || '')}</strong>
            ...
            ${data.projects && data.projects.length ? `
            <div>
              <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#9333EA;margin:0 0 10px;">Projects</h2>
              ${data.projects.map(proj => `
              <div style="margin-bottom:10px;padding-left:12px;border-left:3px solid #E9D5FF;">
          ...
          <div style="width:220px;flex-shrink:0;">
            ...
            ${data.education && data.education.length ? `
            <div style="margin-bottom:22px;">
              <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#9333EA;margin:0 0 10px;">Education</h2>
              ${data.education.map(edu => `
              <div style="margin-bottom:10px;">
            ...
            ${data.skills && data.skills.length ? `
            <div>
              <h2 style="font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#9333EA;margin:0 0 10px;">Skills</h2>
              <div style="display:flex;flex-wrap:wrap;gap:5px;">
                ${data.skills.map(s => `<span style="font-size:10.5px;padding:3px 10px;background:#F3E8FF;color:#7C3AED;border-radius:12px;font-weight:500;">${this._escapeHtml(s.name)}</span>`).join('')}
              </div>
            </div>` : ''}
          </div>
        </div>
  ...
  canva_minimal_3(data) {
    ...
    <div style="width:794px;min-height:1123px;padding:60px 64px;font-family:'Inter',Arial,sans-serif;color:#1a1a1a;line-height:1.55;background:white;box-sizing:border-box;">
      ...
      ${data.summary ? `
      <div style="margin-bottom:24px;">
        <h2 style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#9CA3AF;margin:0 0 10px;">About</h2>
      ...
      ${data.experience && data.experience.length ? `
      <div style="margin-bottom:24px;">
        <h2 style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#9CA3AF;margin:0 0 12px;">Experience</h2>
        ${data.experience.map(exp => `
      ...
      ${data.education && data.education.length ? `
      <div style="margin-bottom:24px;">
        <h2 style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#9CA3AF;margin:0 0 12px;">Education</h2>
        ${data.education.map(edu => `
      ...
      ${data.skills && data.skills.length ? `
      <div style="margin-bottom:24px;">
        <h2 style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#9CA3AF;margin:0 0 10px;">Skills</h2>
        <p style="font-size:12px;color:#4B5563;margin:0;">${data.skills.map(s => this._escapeHtml(s.name)).join('   ·   ')}</p>
      </div>` : ''}
      ...
      ${data.projects && data.projects.length ? `
      <div>
        <h2 style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:2px;color:#9CA3AF;margin:0 0 12px;">Projects</h2>
        ${data.projects.map(proj => `
        <div style="margin-bottom:10px;">
          <strong style="font-size:13px;">${this._escapeHtml(proj.name || '')}</strong>
  ...
  canva_executive_4(data) {
    const p = data.personalInfo || {};
    const contactParts = [p.email, p.phone, p.location].filter(Boolean);
    const photoHtml = p.photoUrl ? `<img src="${p.photoUrl}" style="width:70px;height:70px;border-radius:50%;object-fit:cover;border:3px solid rgba(212,175,55,0.5);">` : '';

    return `
    <div style="width:794px;min-height:1123px;font-family:'Inter',Arial,sans-serif;color:#1a1a1a;line-height:1.5;background:white;box-sizing:border-box;">
      <!-- Dark Header -->
      <div style="background:#0F172A;color:white;padding:36px 50px;display:flex;align-items:center;gap:20px;">
        ${photoHtml}
        <div style="flex:1;">
      ...
      <!-- Gold accent line -->
      <div style="height:3px;background:linear-gradient(90deg,#D4AF37,#F4D03F,#D4AF37);"></div>

      <div style="padding:30px 50px;">
        <!-- Summary -->
        ${data.summary ? `
        <div style="margin-bottom:22px;">
          <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0F172A;margin:0 0 8px;padding-bottom:4px;border-bottom:1px solid #E2E8F0;">Summary</h2>
        ...
        ${data.experience && data.experience.length ? `
        <div style="margin-bottom:22px;">
          <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0F172A;margin:0 0 10px;padding-bottom:4px;border-bottom:1px solid #E2E8F0;">Professional Experience</h2>
          ${data.experience.map(exp => `
          <div style="margin-bottom:14px;">
            <div style="display:flex;justify-content:space-between;align-items:baseline;">
              <strong style="font-size:13px;color:#0F172A;">${this._escapeHtml(exp.title || '')}</strong>
        ...
        <div style="display:flex;gap:36px;">
          ...
          <div style="flex:1;">
            ${data.education && data.education.length ? `
            <div style="margin-bottom:22px;">
              <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0F172A;margin:0 0 10px;padding-bottom:4px;border-bottom:1px solid #E2E8F0;">Education</h2>
              ${data.education.map(edu => `
              <div style="margin-bottom:8px;">
                <strong style="font-size:12px;">${this._escapeHtml(edu.degree || '')}</strong>
            ...
            ${data.projects && data.projects.length ? `
            <div>
              <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0F172A;margin:0 0 10px;padding-bottom:4px;border-bottom:1px solid #E2E8F0;">Projects</h2>
              ${data.projects.map(proj => `
              <div style="margin-bottom:8px;">
                <strong style="font-size:12px;">${this._escapeHtml(proj.name || '')}</strong>
          ...
          <div style="width:200px;flex-shrink:0;">
            <h2 style="font-size:13px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:#0F172A;margin:0 0 10px;padding-bottom:4px;border-bottom:1px solid #E2E8F0;">Expertise</h2>
